...
public class StartGameModeRandom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_game_mode_random);
        ...
        pastNumbers=getIntent().getStringExtra("numOb");
        if(cont<10){
            ...
            multiply=appProcesses.nonRepeatingRandomNumberInt(pastNumbers);
            String multiplyString=String.valueOf(multiply);
            pastNumbers=pastNumbers+multiplyString;
            if(multiply==0){
                multiply=10;
            }
            ...
            imageButtonRestart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    countDownTimer.cancel();
                    AlertDialog.Builder newDialog = new AlertDialog.Builder(StartGameModeRandom.this);
    ...
    public  void nextActivity(){
        ...
        intent.putExtra("numOb", pastNumbers);
        startActivity(intent);
    }
