...
public class StartGameMode extends AppCompatActivity {
private  int selectedTable,multiply,resultA,resultB,resultC,resultD,score,avoidChange;
...
private  long time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_game_mode);
        ...
        multiply=getIntent().getIntExtra("mul",0);
      ...
      if(multuplicationResult==resultA){
        ...
        imageButtonRestart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                countDownTimer.cancel();
                AlertDialog.Builder newDialog = new AlertDialog.Builder(StartGameMode.this);
